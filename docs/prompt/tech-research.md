# tech-research · arquivo para anexar
...
---
name: tech-research
description: Conduz pesquisa técnica com cobertura, referências e registro de aprendizado Use quando o pedido corresponder a tech research.
version: 0.4.0
license: Authorized redistribution
author: AIOX Embaixadores
---

# Pesquisa técnica profunda
...
- Fonte: [https://github.com/aiox-embaixadores/aiox-embaixador-pro](https://github.com/aiox-embaixadores/aiox-embaixador-pro/tree/a137d3b87af63a8b05ef51cab8ea293d44a2a1c4/skills/tech-research)
...
```json
{
  "source_url": "https://github.com/aiox-embaixadores/aiox-embaixador-pro/tree/a137d3b87af63a8b05ef51cab8ea293d44a2a1c4/skills/tech-research",
  ...
  "files": [
    {
      "path": "SKILL.md",
      "sha256": "527c4f80b9571be5b9ff8c444c22da78ff453c2192a0df4dc0d7e97ed6b31412"
    }
  ]
}
```
...
---
name: tech-research
description: "Deep technical research pipeline (7 molecules, 11 atoms) with multi-wave search, coverage scoring, multi-LLM cross-reference, citation verification, and incremental learning log. Phase 3 routes academic queries to scholarly databases (arXiv, PubMed, Semantic Scholar via @sinkra/research-adapters) before generic WebSearch. Produces evidence-graded research dossiers under docs/research/. Optional product-discovery mode feeds the research-chief validate-product-idea molecule."
version: "2.0.0"
user-invocable: true
