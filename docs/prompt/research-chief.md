# research-chief · arquivo para anexar
...
---
name: research-chief
description: Orquestra pesquisa técnica, competitiva e de marketing Use quando o pedido corresponder a research chief.
version: 0.4.0
license: Authorized redistribution
author: AIOX Embaixadores
---

# Pesquisa bem roteada
...
- Fonte: [https://github.com/aiox-embaixadores/aiox-embaixador-pro](https://github.com/aiox-embaixadores/aiox-embaixador-pro/tree/a137d3b87af63a8b05ef51cab8ea293d44a2a1c4/skills/research-chief)
...
```json
{
  "source_url": "https://github.com/aiox-embaixadores/aiox-embaixador-pro/tree/a137d3b87af63a8b05ef51cab8ea293d44a2a1c4/skills/research-chief",
  ...
  "files": [
    {
      "path": "SKILL.md",
      "sha256": "af520e247f13b542913dfb2ede0e60077c6ceba2a8f683f62c5ca5114b21bc22"
    }
  ]
}
```
...
---
name: "research-chief"
description: "Research operations orchestrator — dispatches to specialist modes (tech research, marketing deep-dive, A-vs-B benchmarks, competitive intelligence). Analyze competitors, extract viral content patterns, generate actionable insights for content creation, and benchmark AIOX against competing AI frameworks."
version: "5.0.0"
...
4. SAVE
   └── docs/research/{YYYY-MM-DD}-{handle}-{platform}/   (publication; 1 player)
```
...
| Type | Path |
|------|------|
| YouTube Analysis (1 channel) | `docs/research/{YYYY-MM-DD}-{channel}-youtube/` |
| Instagram Analysis (1 profile) | `docs/research/{YYYY-MM-DD}-{profile}-instagram/` |
| Comparatives (multi-player) | `docs/bench/{topic}/` |
| Trends Reports | `docs/research/{YYYY-MM-DD}-trends-{topic}/` |
| Benchmarks (A vs B) | `docs/bench/{slug}/` |
| Framework Audits | `docs/audits/{YYYY-MM-DD}-{topic}/` |
| Raw API data / transcripts (ephemeral) | `outputs/research/{raw,transcripts}/` |
...
completion_criteria:
  analysis_complete:
    ...
    - "Sources cited"
    - "Report saved to docs/research/, docs/bench/ or docs/audits/ depending on type (publications); ephemeral data in outputs/research/"
