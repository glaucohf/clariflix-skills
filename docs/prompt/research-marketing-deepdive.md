# research-marketing-deepdive · arquivo para anexar
...
---
name: research-marketing-deepdive
description: Investiga players, tendências, conteúdo e oportunidades de mercado Use quando o pedido corresponder a research marketing deepdive.
version: 0.4.0
license: Authorized redistribution
author: AIOX Embaixadores
---

# Marketing em profundidade
...
- Fonte: [https://github.com/aiox-embaixadores/aiox-embaixador-pro](https://github.com/aiox-embaixadores/aiox-embaixador-pro/tree/a137d3b87af63a8b05ef51cab8ea293d44a2a1c4/skills/research-marketing-deepdive)
...
```json
{
  "source_url": "https://github.com/aiox-embaixadores/aiox-embaixador-pro/tree/a137d3b87af63a8b05ef51cab8ea293d44a2a1c4/skills/research-marketing-deepdive",
  ...
  "files": [
    {
      "path": "SKILL.md",
      "sha256": "929c2267ac1bed3574028e433dae6e282a24e6ea77e42e6b9c3027e83f218260"
    }
  ]
}
```
...
---
name: "research-marketing-deepdive"
description: "1-player marketing deep-dive specialist. Deep player analysis, trend research, content DNA extraction, swipe file generation, market gap identification. Outputs to docs/research/{date}-{slug}/."
version: "5.0.0"
...
anti_patterns:
  ...
  always_do:
    ...
    - "Save published deep-dive reports to docs/research/{YYYY-MM-DD}-{slug}/ (1-player); ephemeral raw/transcripts/swipe data to outputs/research/"
```
...
completion_criteria:
  deep_dive_complete:
    ...
    - "Report saved to docs/research/{YYYY-MM-DD}-{slug}/"
