...
dependencies:
  ...
  tasks:
    ...
    - an-assess-sources-prioritize.md
    - an-assess-sources-output.md
    ...
    - validate-squad-report.md
    # Optimization tasks
    - optimize.md  # Otimiza execução + análise de economia
    - optimize-target-inventory.md
