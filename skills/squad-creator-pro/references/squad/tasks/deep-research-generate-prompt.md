...
- [ ] REFINED TOPIC is specific, not generic
- [ ] SCOPE has 4-6 investigative angles with sub-points
- [ ] REQUIREMENTS specify source priority and analysis depth
- [ ] RECOMMENDED SOURCES list concrete titles/types (not vague)
- [ ] EXPECTED RESULTS are actionable deliverables (templates, checklists), not theory
- [ ] If research_mode is "complementary", prompt focuses on gaps from Phase 1
