...
- [ ] Sources below threshold (< 5/10) excluded with reason
- [ ] Coverage validation decision rendered (GO / CONDITIONAL / NO_GO)
- [ ] `source_inventory.yaml` written to output path
