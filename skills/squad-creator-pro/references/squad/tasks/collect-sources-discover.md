...
- [ ] All required inputs validated before starting discovery
- [ ] Fallback chain executed in order (user materials -> auto-acquire -> manual search -> fail)
- [ ] All 10+ search queries executed for manual search phase
- [ ] Sources cataloged by type with title, year/date, URL, and relevance
- [ ] At least 10 raw sources discovered OR fail condition triggered with user notification
