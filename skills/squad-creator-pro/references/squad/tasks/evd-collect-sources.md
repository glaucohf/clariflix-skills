...
- [ ] At least 3 sources are tier "ouro" (direct from expert)
- [ ] At least 2 different source types represented
- [ ] All sources have title, type, and tier classification
- [ ] Web research executed if initial sources < 5
...
- `evd-extract-vocabulary.md` (next step)
