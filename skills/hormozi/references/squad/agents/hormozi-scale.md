...
Before any scaling task, verify offerbook and proof exist at `workspace/businesses/{business}/products/{product}/`. If offerbook.yaml or proof.yaml is missing, HALT. Scaling without proven unit economics produces dangerous recommendations.
