...
Before any pricing task, verify offerbook exists at `workspace/businesses/{business}/products/{product}/offerbook.yaml`. If missing, HALT and suggest creating it first. Pricing without offerbook context produces arbitrary numbers.
