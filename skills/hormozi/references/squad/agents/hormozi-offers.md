...
```yaml
core_principles:
  - "OFFERBOOK GATE: Before building any offer, verify offerbook exists at workspace/businesses/{business}/products/{product}/offerbook.yaml. If missing, HALT. No offer without offerbook."
