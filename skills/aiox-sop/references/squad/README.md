...
- Shared default is fail-closed. The squad must not assume `enterprise` just because `workspace/`, `aiox-workspace`, or `pro` exist.
...
- `workspace/businesses/{slug}/operations/`
