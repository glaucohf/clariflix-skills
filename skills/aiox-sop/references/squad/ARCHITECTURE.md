...
audit work that needs real company/operations data.
...
- `workspace/businesses/{business}/company/offerbook.yaml` when present
- `workspace/businesses/{business}/operations/team-structure.yaml`
- `workspace/businesses/{business}/operations/pricing-strategy.yaml`
- `workspace/businesses/{business}/operations/kpi-scorecards.yaml`
- `workspace/businesses/{business}/operations/commission-design.yaml` when present
