...
**Onde vivem os outputs:** `workspace/businesses/{slug}/operations/` - cada business recebe seus próprios arquivos. O sop-chief lê esses arquivos via `workspace/businesses/` (já declarado nos read_paths do aiox-sop config.yaml) para saber quais SOPs básicas criar.
...
- **workspace_businesses** (directory)
  ...
  - Required: Yes
  - Source: `workspace/businesses/*/company/company-profile.yaml`
...
- **operations_yamls** (directory)
  ...
  - Source: `workspace/businesses/*/operations/`
...
- **sop-research-context.yaml** (por business)
  ...
  - Destination: `workspace/businesses/{slug}/operations/sop-research-context.yaml`
...
- **sop-backlog.yaml** (por business)
  ...
  - Destination: `workspace/businesses/{slug}/operations/sop-backlog.yaml`
...
**Substeps:**
- [ ] Ler `company/company-profile.yaml` de cada business
...
- [ ] Verificar existência de `operations/` e `sops/` em cada business
...
revenue: company.revenue_range      # Ex: "R$5-20M", "R$100M+"
...
|----|-----------|------|------------|-------------------|
| CAT-01 | EdTech / Educação Online | `edtech` | eu_medico_residente, nexos_educacao, ecossistema_builder, omni_hypnosis, academia_lendaria, aiox | R$1M-R$20M+ |
| CAT-02 | Desenvolvimento Pessoal / Coaching | `personal-dev` | grupo_scalco, vida_lendaria, mentoria_andre_franco | R$3M-R$5M+ |
| CAT-03 | SaaS / Tecnologia | `saas-tech` | youfront, optimus_isystem, ecossistema_builder (Easy Builder) | <R$500K-R$3M |
| CAT-04 | Agência / Serviços de Marketing | `marketing-agency` | grupo_fabio_avelar, youfront, nutraself | R$5M+ |
| CAT-05 | Gaming / Entretenimento | `gaming` | level8_herobase | R$5M+ |
| CAT-06 | Healthcare / MedTech | `healthcare-medtech` | conta_magic, eu_medico_residente | R$20M-R$120M |
| CAT-07 | Turismo / Gastronomia | `tourism-gastronomy` | brasil_em_dobro | R$1.7M+ |
| CAT-08 | Telecom / Multi-negócios | `telecom-multi` | grupo_wv | R$35M+ |
| CAT-09 | Cripto / Investimentos | `crypto-finance` | mentoria_andre_franco | R$3-16M |
| CAT-10 | Direct Response / eCommerce | `direct-response` | nutraself | R$5M+ |
...
| ID | Processo Core | Evidência | Businesses |
|----|--------------|-----------|------------|
| PC-04-01 | Pipeline de propostas comerciais | Case AllFluence: R$11/proposta vs R$750 | grupo_fabio, youfront |
...
| PC-08-03 | Controle administrativo multi-empresa | R$2M/ano de custo admin | grupo_wv |
...
- [ ] Gerar `workspace/businesses/{slug}/operations/sop-research-context.yaml`
- [ ] Gerar `workspace/businesses/{slug}/operations/sop-backlog.yaml`
...
```yaml
# workspace/businesses/{slug}/operations/sop-research-context.yaml
business:
...
```yaml
# workspace/businesses/{slug}/operations/sop-backlog.yaml
business:
  slug: "brasil_em_dobro"
  name: "Brasil em Dobro"
...
- [ ] **AC-07:** category-map.yaml em `squads/aiox-sop/data/`, per-business outputs em `workspace/businesses/{slug}/operations/`
...
quality_gate:
  ...
  pass_action:
    ...
    - "Per-business backlog publicado em workspace/businesses/*/operations/"
...
- **sop-research-context.yaml**: `workspace/businesses/{slug}/operations/` - Categoria, processos core, processos burros, research gaps
- **sop-backlog.yaml**: `workspace/businesses/{slug}/operations/` - Backlog priorizado de SOPs a criar
...
### Business sem company-profile.yaml

- **Trigger:** Diretório existe mas não tem company-profile.yaml
...
- **SOP Chief:** Lê `workspace/businesses/{slug}/operations/sop-research-context.yaml` para saber quais SOPs básicas cada business precisa. Fonte primária de análise.
...
# 35 sop-research-context.yaml em workspace/businesses/*/operations/
# 35 sop-backlog.yaml em workspace/businesses/*/operations/
...
```yaml
# workspace/businesses/brasil_em_dobro/operations/sop-research-context.yaml
business:
  slug: "brasil_em_dobro"
  name: "Brasil em Dobro"
  primary_category:
...
```yaml
# workspace/businesses/eu_medico_residente/operations/sop-backlog.yaml
business:
