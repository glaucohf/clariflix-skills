...
elicit: false
autonomous: true
description: "Load canonical business context from workspace/company + workspace/operations when the user wants business-aware SOP analysis."
```
...
- `workspace/businesses/{slug}/company/offerbook.yaml` (optional)
...
- `workspace/businesses/{slug}/operations/kpi-scorecards.yaml`
- `workspace/businesses/{slug}/operations/commission-design.yaml` (optional)
...
- STOP if required `company/` or `operations/` sources are missing
