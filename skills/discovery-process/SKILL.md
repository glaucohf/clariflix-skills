...
description: Conduz um ciclo de discovery de hipótese a experimento e decisão Use quando o pedido corresponder a discovery process.
version: 0.3.0
license: CC BY-NC-SA 4.0
author: Dean Peters
---

# Discovery antes do build
